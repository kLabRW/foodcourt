...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ToppingsAndExtrasCategory.title'
        db.alter_column(u'optionalitems_toppingsandextrascategory', 'title', self.gf('django.db.models.fields.CharField')(max_length=140))

    def backwards(self, orm):

        # Changing field 'ToppingsAndExtrasCategory.title'
        db.alter_column(u'optionalitems_toppingsandextrascategory', 'title', self.gf('django.db.models.fields.CharField')(max_length=20))
