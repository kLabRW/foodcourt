...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Optional_Item.name'
        db.alter_column(u'optionalitems_optional_item', 'name', self.gf('django.db.models.fields.CharField')(max_length=140))

        # Changing field 'OptionalItemCategory.title'
        db.alter_column(u'optionalitems_optionalitemcategory', 'title', self.gf('django.db.models.fields.CharField')(max_length=140))

    def backwards(self, orm):

        # Changing field 'Optional_Item.name'
        db.alter_column(u'optionalitems_optional_item', 'name', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'OptionalItemCategory.title'
        db.alter_column(u'optionalitems_optionalitemcategory', 'title', self.gf('django.db.models.fields.CharField')(max_length=20))
