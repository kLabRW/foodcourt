...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Optional_Item.description'
        db.alter_column(u'optionalitems_optional_item', 'description', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Optional_Item.description'
        db.alter_column(u'optionalitems_optional_item', 'description', self.gf('django.db.models.fields.CharField')(default=1, max_length=200))
