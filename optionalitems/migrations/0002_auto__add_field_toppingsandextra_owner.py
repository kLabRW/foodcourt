...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ToppingsAndExtra.owner'
        db.add_column(u'optionalitems_toppingsandextra', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['restaurant_detail.Restaurant']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ToppingsAndExtra.owner'
        db.delete_column(u'optionalitems_toppingsandextra', 'owner_id')
