...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Optional_Item'
        db.create_table(u'optionalitems_optional_item', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='optional_item_creations', to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='optional_item_modifications', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'optionalitems', ['Optional_Item'])
        ...
        db.create_unique(m2m_table_name, ['optionalitemcategory_id', 'optional_item_id'])

        # Adding model 'ToppingsAndExtras'
        db.create_table(u'optionalitems_toppingsandextras', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='toppingsandextras_creations', to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='toppingsandextras_modifications', to=orm['auth.User'])),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=140)),
            ('price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=2, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True)),
        ))
        db.send_create_signal(u'optionalitems', ['ToppingsAndExtras'])
        ...
        db.create_unique(m2m_table_name, ['toppingsandextrascategory_id', 'toppingsandextras_id'])


    def backwards(self, orm):
        # Deleting model 'Optional_Item'
        db.delete_table(u'optionalitems_optional_item')
        ...
        # Deleting model 'ToppingsAndExtras'
        db.delete_table(u'optionalitems_toppingsandextras')
