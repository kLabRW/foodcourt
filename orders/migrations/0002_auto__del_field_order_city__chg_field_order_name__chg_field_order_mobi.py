...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('orders_order', 'name', self.gf('django.db.models.fields.CharField')(default='mark', max_length=50))

        # Changing field 'Order.mobile'
        db.alter_column('orders_order', 'mobile', self.gf('phonenumber_field.modelfields.PhoneNumberField')(default=250785559899L, max_length=20))

        # Changing field 'Order.address'
        db.alter_column('orders_order', 'address', self.gf('django.db.models.fields.CharField')(default='kacyiru', max_length=50))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Order.name'
        db.alter_column('orders_order', 'name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Order.mobile'
        db.alter_column('orders_order', 'mobile', self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=20, null=True))

        # Changing field 'Order.address'
        db.alter_column('orders_order', 'address', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
