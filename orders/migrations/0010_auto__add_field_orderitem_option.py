...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderItem.option'
        db.add_column('order_items', 'option',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['optionalitems.Optional_Item'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderItem.option'
        db.delete_column('order_items', 'option_id')
    ...
    models = {
        ...
        u'orders.no_option': {
            'Meta': {'object_name': 'No_Option'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'none': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        u'orders.order': {
