...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('orders_order', 'billing_address')

        # Deleting field 'Order.billing_name'
        db.delete_column('orders_order', 'billing_name')

        # Deleting field 'Order.billing_city'
        db.delete_column('orders_order', 'billing_city')

        # Adding field 'Order.name'
        db.add_column('orders_order', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.Address'
        db.add_column('orders_order', 'Address',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.City'
        db.add_column('orders_order', 'City',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.additional_information'
        db.add_column('orders_order', 'additional_information',
                      self.gf('django.db.models.fields.TextField')(max_length=250, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Order.mobile'
        db.alter_column('orders_order', 'mobile', self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=20, null=True))

    def backwards(self, orm):
        # Adding field 'Order.billing_address'
        db.add_column('orders_order', 'billing_address',
                      self.gf('django.db.models.fields.CharField')(default='klab', max_length=50),
                      keep_default=False)

        # Adding field 'Order.billing_name'
        db.add_column('orders_order', 'billing_name',
                      self.gf('django.db.models.fields.CharField')(default='mark', max_length=50),
                      keep_default=False)

        # Adding field 'Order.billing_city'
        db.add_column('orders_order', 'billing_city',
                      self.gf('django.db.models.fields.CharField')(default='kigali', max_length=50),
                      keep_default=False)

        # Deleting field 'Order.name'
        db.delete_column('orders_order', 'name')

        # Deleting field 'Order.Address'
        db.delete_column('orders_order', 'Address')

        # Deleting field 'Order.City'
        db.delete_column('orders_order', 'City')

        # Deleting field 'Order.additional_information'
        db.delete_column('orders_order', 'additional_information')


        # Changing field 'Order.mobile'
        db.alter_column('orders_order', 'mobile', self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=20))
    ...
    models = {
        ...
        'orders.order': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'mobile': ('phonenumber_field.modelfields.PhoneNumberField', [], {'default': "'+25078######'", 'max_length': '20', 'null': 'True', 'blank': 'True'}),
