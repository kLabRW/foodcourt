...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('order_items', (
            ...
            ('option', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['optionalitems.Optional_Item'], null=True, blank=True)),
        ))
        db.send_create_signal(u'orders', ['OrderItem'])

        # Adding M2M table for field toppings_and_extras on 'OrderItem'
        m2m_table_name = db.shorten_name('order_items_toppings_and_extras')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('orderitem', models.ForeignKey(orm[u'orders.orderitem'], null=False)),
            ('toppingsandextras', models.ForeignKey(orm[u'optionalitems.toppingsandextras'], null=False))
        ))
        db.create_unique(m2m_table_name, ['orderitem_id', 'toppingsandextras_id'])
        ...
        db.create_table(u'orders_order', (
            ...
            ('mobile', self.gf('phonenumber_field.modelfields.PhoneNumberField')(max_length=20)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('additional_information', self.gf('django.db.models.fields.TextField')(max_length=250, null=True, blank=True)),
        ))
        db.send_create_signal(u'orders', ['Order'])

        # Adding model 'Recieved_Order'
        db.create_table(u'orders_recieved_order', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ...
        db.send_create_signal(u'orders', ['Recieved_Order'])

        # Adding M2M table for field toppings_and_extras on 'Recieved_Order'
        m2m_table_name = db.shorten_name(u'orders_recieved_order_toppings_and_extras')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('recieved_order', models.ForeignKey(orm[u'orders.recieved_order'], null=False)),
            ('toppingsandextras', models.ForeignKey(orm[u'optionalitems.toppingsandextras'], null=False))
        ))
        db.create_unique(m2m_table_name, ['recieved_order_id', 'toppingsandextras_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field toppings_and_extras on 'OrderItem'
        db.delete_table(db.shorten_name('order_items_toppings_and_extras'))

        # Deleting model 'Order'
        db.delete_table(u'orders_order')

        # Deleting model 'Recieved_Order'
        db.delete_table(u'orders_recieved_order')

        # Removing M2M table for field toppings_and_extras on 'Recieved_Order'
        db.delete_table(db.shorten_name(u'orders_recieved_order_toppings_and_extras'))
    ...
    models = {
        ...
        u'orders.orderitem': {
            ...
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'option': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['optionalitems.Optional_Item']", 'null': 'True', 'blank': 'True'}),
            'quantity': ('django.db.models.fields.IntegerField', [], {}),
            'shopping_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'}),
            'toppings_and_extras': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['optionalitems.ToppingsAndExtras']", 'null': 'True', 'blank': 'True'})
        },
