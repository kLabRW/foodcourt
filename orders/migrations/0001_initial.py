...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('order_items', (
            ...
            ('shopping_id', self.gf('django.db.models.fields.CharField')(max_length=50, db_index=True)),
    ...
    models = {
        ...
        'orders.orderitem': {
            ...
            'shopping_id': ('django.db.models.fields.CharField', [], {'max_length': '50', 'db_index': 'True'})
        },
        ...
        'restaurant_detail.restaurant': {
            ...
            'service_fee': ('django.db.models.fields.IntegerField', [], {'max_length': '5'}),
