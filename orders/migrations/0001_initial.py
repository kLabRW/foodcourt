...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('order_items', (
            ...
            ('option', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['optionalitems.OptionalItem'], null=True, blank=True)),
        ))
        ...
        db.create_unique(m2m_table_name, ['orderitem_id', 'toppingsandextra_id'])
        ...
        # Adding model 'RecievedOrder'
        db.create_table(u'orders_recievedorder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='recievedorder_creations', to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='recievedorder_modifications', to=orm['auth.User'])),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant_detail.Item'])),
        ...
        db.send_create_signal(u'orders', ['RecievedOrder'])

        # Adding M2M table for field toppings_and_extras on 'RecievedOrder'
        m2m_table_name = db.shorten_name(u'orders_recievedorder_toppings_and_extras')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('recievedorder', models.ForeignKey(orm[u'orders.recievedorder'], null=False)),
            ('toppingsandextra', models.ForeignKey(orm[u'optionalitems.toppingsandextra'], null=False))
        ))
        db.create_unique(m2m_table_name, ['recievedorder_id', 'toppingsandextra_id'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'RecievedOrder'
        db.delete_table(u'orders_recievedorder')

        # Removing M2M table for field toppings_and_extras on 'RecievedOrder'
        db.delete_table(db.shorten_name(u'orders_recievedorder_toppings_and_extras'))
