...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'No_Option'
        db.delete_table(u'orders_no_option')

        # Adding field 'OrderItem.toppings_and_extras'
        db.add_column('order_items', 'toppings_and_extras',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['optionalitems.ToppingsAndExtras'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Recieved_Order.toppings_and_extras'
        db.add_column(u'orders_recieved_order', 'toppings_and_extras',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['optionalitems.ToppingsAndExtras']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'No_Option'
        db.create_table(u'orders_no_option', (
            ('none', self.gf('django.db.models.fields.IntegerField')(default=0)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'orders', ['No_Option'])

        # Deleting field 'OrderItem.toppings_and_extras'
        db.delete_column('order_items', 'toppings_and_extras_id')

        # Deleting field 'Recieved_Order.toppings_and_extras'
        db.delete_column(u'orders_recieved_order', 'toppings_and_extras_id')
    ...
    models = {
        ...
        u'orders.orderitem': {
            ...
            'toppings_and_extras': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['optionalitems.ToppingsAndExtras']", 'null': 'True', 'blank': 'True'})
        },
        u'orders.recieved_order': {
            ...
            'toppings_and_extras': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['optionalitems.ToppingsAndExtras']"})
        },
