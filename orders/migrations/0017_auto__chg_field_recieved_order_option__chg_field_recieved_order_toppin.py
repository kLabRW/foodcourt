...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Recieved_Order.option'
        db.alter_column(u'orders_recieved_order', 'option_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['optionalitems.Optional_Item'], null=True))

        # Changing field 'Recieved_Order.toppings_and_extras'
        db.alter_column(u'orders_recieved_order', 'toppings_and_extras_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['optionalitems.ToppingsAndExtras'], null=True))

    def backwards(self, orm):

        # Changing field 'Recieved_Order.option'
        db.alter_column(u'orders_recieved_order', 'option_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['optionalitems.Optional_Item']))

        # Changing field 'Recieved_Order.toppings_and_extras'
        db.alter_column(u'orders_recieved_order', 'toppings_and_extras_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['optionalitems.ToppingsAndExtras']))
