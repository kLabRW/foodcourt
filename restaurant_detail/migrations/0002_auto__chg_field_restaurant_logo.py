...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'restaurant_detail_restaurant', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=600, null=True))

    def backwards(self, orm):

        # Changing field 'Restaurant.logo'
        db.alter_column(u'restaurant_detail_restaurant', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=500, null=True))
