...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Restaurant.closing_message'
        db.add_column(u'restaurant_detail_restaurant', 'closing_message',
                      self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RestaurantDetail.closing_message'
        db.add_column(u'restaurant_detail_restaurantdetail', 'closing_message',
                      self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Restaurant.closing_message'
        db.delete_column(u'restaurant_detail_restaurant', 'closing_message')

        # Deleting field 'RestaurantDetail.closing_message'
        db.delete_column(u'restaurant_detail_restaurantdetail', 'closing_message')
