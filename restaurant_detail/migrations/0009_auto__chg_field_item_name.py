...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('items', 'name', self.gf('django.db.models.fields.CharField')(max_length=140))

    def backwards(self, orm):

        # Changing field 'Item.name'
        db.alter_column('items', 'name', self.gf('django.db.models.fields.CharField')(max_length=64))
