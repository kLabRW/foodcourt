...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RestaurantDetail'
        db.create_table(u'restaurant_detail_restaurantdetail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='restaurantdetail_creations', to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='restaurantdetail_modifications', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'restaurant_detail', ['RestaurantDetail'])
        ...
        db.create_table(u'restaurant_detail_restaurant', (
            ...
            ('restaurant_detail', self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['restaurant_detail.RestaurantDetail'])),
        ))
        ...
        # Adding M2M table for field toppings_and_extras on 'Item'
        m2m_table_name = db.shorten_name('items_toppings_and_extras')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('item', models.ForeignKey(orm[u'restaurant_detail.item'], null=False)),
            ('toppingsandextrascategory', models.ForeignKey(orm[u'optionalitems.toppingsandextrascategory'], null=False))
        ))
        db.create_unique(m2m_table_name, ['item_id', 'toppingsandextrascategory_id'])
    ...
    def backwards(self, orm):
        # Deleting model 'RestaurantDetail'
        db.delete_table(u'restaurant_detail_restaurantdetail')
        ...
        # Removing M2M table for field toppings_and_extras on 'Item'
        db.delete_table(db.shorten_name('items_toppings_and_extras'))
