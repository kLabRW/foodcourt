...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Restaurant.restaurant_detail'
        db.alter_column(u'restaurant_detail_restaurant', 'restaurant_detail_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant_detail.RestaurantDetail']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Restaurant.restaurant_detail'
        db.alter_column(u'restaurant_detail_restaurant', 'restaurant_detail_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant_detail.Restaurant_detail']))
