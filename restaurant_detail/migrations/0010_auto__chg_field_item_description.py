...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('items', 'description', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Item.description'
        db.alter_column('items', 'description', self.gf('django.db.models.fields.CharField')(default=1, max_length=200))
