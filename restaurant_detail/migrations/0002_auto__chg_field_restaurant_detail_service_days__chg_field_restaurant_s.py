...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Restaurant_detail.service_days'
        db.alter_column(u'restaurant_detail_restaurant_detail', 'service_days', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Restaurant.service_days'
        db.alter_column(u'restaurant_detail_restaurant', 'service_days', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Restaurant_detail.service_days'
        db.alter_column(u'restaurant_detail_restaurant_detail', 'service_days', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'Restaurant.service_days'
        db.alter_column(u'restaurant_detail_restaurant', 'service_days', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))
