...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Restaurant_detail.delivery_territory'
        db.alter_column('restaurant_detail_restaurant_detail', 'delivery_territory', self.gf('django.db.models.fields.TextField')(max_length=500, null=True))

        # Changing field 'Restaurant_detail.minimum_order_amount'
        db.alter_column('restaurant_detail_restaurant_detail', 'minimum_order_amount', self.gf('django.db.models.fields.IntegerField')(max_length=5, null=True))

        # Changing field 'Restaurant.delivery_territory'
        db.alter_column('restaurant_detail_restaurant', 'delivery_territory', self.gf('django.db.models.fields.TextField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'Restaurant_detail.delivery_territory'
        db.alter_column('restaurant_detail_restaurant_detail', 'delivery_territory', self.gf('django.db.models.fields.TextField')(default='kacyiru'))

        # Changing field 'Restaurant_detail.minimum_order_amount'
        db.alter_column('restaurant_detail_restaurant_detail', 'minimum_order_amount', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=5))

        # Changing field 'Restaurant.delivery_territory'
        db.alter_column('restaurant_detail_restaurant', 'delivery_territory', self.gf('django.db.models.fields.TextField')(default='kacyiru'))
