...
class Restaurant_detail(SmartModel):
	...
	service_days=models.CharField(max_length=5, help_text= "Working days e.g Tue - Sun")
...
#	piglet=models.CharField(max_length=5,null=True,blank=True,help_text='oink,oink')
	...
	service_days=models.CharField(max_length=5,null=True,blank=True,help_text= "Working days, e.g Tue - Sun")
